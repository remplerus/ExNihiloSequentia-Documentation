...
const config = {
  ...
  organizationName: 'NovaMachina', // Usually your GitHub org/user name.
  projectName: 'ExNihiloSequentia-Documentation', // Usually your repo name.
